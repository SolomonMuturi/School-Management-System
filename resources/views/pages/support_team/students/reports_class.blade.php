<html>
<head>
    <title>Class List - {{ $my_class->name }}</title>
...
<div class="container">
    <div id="print">
        <table width="100%">
            <tr>
                ...
                <td style="text-align: center; ">
                    ...
                    <strong><span style="color: #000; font-size: 15px;">CLASS LIST - {{ strtoupper($my_class->name) }} ({{ Qs::getSetting('current_session') }})</span></strong>
                </td>
            </tr>
        </table>
        <br/>
        ...
        <br/>
        <p>Total Number of Students in {{ $my_class->name }}: <strong>{{ $students->count() }}</strong></p>
